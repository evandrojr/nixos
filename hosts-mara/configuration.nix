...

{
 ...
 #   autoLogin.user = "dg"; # Substitua por seu nome de usuário
 # };
  
    services.displayManager.defaultSession = "xfce"; # Substitua por sua sessão desejada
...
zramSwap = {
  enable = true;
  memoryPercent = 75; # Ajuste conforme necessário
};
